...
Finally, a (neighboring) patch containing $P$ is found by applying point-in-box tests to bounding boxes (see Sec.~\ref{sec:spherical-patches}) of all the patches of $S$.} 
