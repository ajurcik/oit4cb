...
We define the \textit{surface graph} using triangles representing vertices and toroidal patches (recall that a ) representing edges since each toroidal patch is delimited by two triangles (Fig.~\ref{fig:graph}).
