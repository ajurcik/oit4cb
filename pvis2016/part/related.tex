...
Bavoil et al.~\cite{bavoil2008order} introduced the peeling of two depth layers in one rendering pass, thus halving the time complexity of the original Depth Peeling approach \cite{everitt2001interactive}.
...
McGuire and Bavoil~\cite{mcguire2013weighted} employ specific coloring of objects to reach this goal, whereas Enderton et al.~\cite{enderton2011stochastic} introduce statistics for the same purpose.
