...
\begin{itemize}
  \item Accelerated and improved rendering pipeline for the transparent solvent-excluded surface (SES) of the molecule (in comparison with Kauker et al.~\cite{kauker2013rendering}).
