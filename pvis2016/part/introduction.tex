...
\begin{itemize}
  \item Enhanced computation of solvent-excluded surface (SES) of the molecule. We propose three new kernels that account for \textcolor{red}{speedup of the existing state-of-the-art approach~\cite{krone2011parallel}}.
