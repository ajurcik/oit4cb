...
The \textit{AND} operation leaves only fragments that appear on positive sides of both clipping planes, while the \textit{OR} operation leaves fragments that appear on the positive side of the first or the second clipping plane.
