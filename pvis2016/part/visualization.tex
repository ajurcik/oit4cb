...
\begin{figure}[htp]
  ...
  \end{subfigure}
	\caption{Ray-tracing a toroidal patch. The saddle part of the torus (left) is cut by the \textit{visibility sphere}.
The patch (right) is cut from the whole toroidal ring by clipping planes defined by spherical triangles.}
	\label{fig:torus}
\end{figure}
