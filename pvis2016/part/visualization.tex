...
\begin{figure}[htp]
  ...
  \end{subfigure}
	\caption{Ray-tracing a toroidal patch. Left: the saddle part of the torus (blue) is cut by the \textit{visibility sphere} (yellow) \textcolor{blue}{-- introduced in~\cite{krone2009interactive}}.
