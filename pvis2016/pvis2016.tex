...
\teaser{
  ...
  \caption{An example of protein 1VIS demonstrating our visualization method. Left: The full SES model (17.4 FPS). Middle: Enabling basic transparency (18.9 FPS). Right: A user defined transparent visualization that includes cavities (17.4 FPS).
