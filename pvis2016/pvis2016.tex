...
\teaser{
  ...
  \caption{An example of protein \textit{1VIS} demonstrating our visualization method. Left: The full SES model (33.3 FPS). Middle: Enabling basic transparency (33.3 FPS). Right: A user defined transparent visualization that includes cavities (32.2 FPS).
