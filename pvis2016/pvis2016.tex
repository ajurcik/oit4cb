...
\title{Accelatered Visualization of Transparenent Molecular Surfaces\\in Molecular Dynamics}
...
\teaser{
  ...
  \caption{An example of protein \textit{1VIS} demonstrating our visualization method. Left: The full SES model (17.4 FPS). Middle: Enabling basic transparency (18.9 FPS). Right: A user defined transparent visualization that includes cavities (17.4 FPS).
	The performance of the visualization was measured using resolution of 1024 $\times$ 768 and the fill rate was 48.3\%.}
	\label{fig:teaser}
}
